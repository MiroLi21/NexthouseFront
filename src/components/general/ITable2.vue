...
import type { ITableItem, ITableHeader } from "./ITable";
    ...
    <body>
      ${
        props.caption || props.title
          ? `<div class="print-caption">${props.caption || props.title}</div>`
          : ""
      }
...
<template>
  <div class="table-container my-2">
    <div v-if="props.items.length">
      ...
      <div
        id="printable-table"
        class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm bg-white dark:bg-gray-900"
      >
        <table class="w-full border-collapse text-sm">
          <thead>
            <tr
              class="sticky top-0 z-10 bg-gradient-to-r from-gray-50 to-gray-300 dark:from-gray-800 dark:to-gray-750 border-b border-gray-200 dark:border-gray-600 backdrop-blur"
            >
              <th
                v-if="props.showRowNumber"
                scope="col"
                class="px-4 py-3 text-center text-xs font-bold text-gray-700 dark:text-gray-200 uppercase tracking-wider border-r border-gray-200 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 sticky left-0 z-20"
                title="Row number"
              >
                #
              </th>
              ...
              <th
                ...
                :class="[
                  ...
                  'bg-gray-100/60 dark:bg-gray-700/60 hover:bg-gray-200/70 dark:hover:bg-gray-600/70',
                ...
                :aria-sort="
                  sortKey === header.value
                    ...
                    : 'none'
                "
                :aria-label="`Sort by ${header.caption}`"
              >
                <div class="flex items-center justify-between group">
                  ...
                  <div class="flex items-center ml-2 print-hide">
                    <span
                      ...
                      class="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 font-semibold"
                    >
                      <svg
                        v-if="sortAsc"
                        class="w-4 h-4"
                    ...
                    <svg
                      v-else
                      class="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 opacity-0 group-hover:opacity-60 transition-opacity"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <tr
              ...
              :key="rowIndex"
              class="transition-all duration-150 group hover:bg-blue-50/70 dark:hover:bg-gray-700/40 odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-850"
            >
              <td
                v-if="props.showRowNumber"
                class="px-4 py-3 text-center text-sm text-gray-600 dark:text-gray-300 font-medium border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 group-hover:bg-blue-100/70 dark:group-hover:bg-gray-600/40 sticky left-0 z-10"
              >
      ...
      <div
        ...
        v-if="showPagination && props.items.length"
      >
...
.custom-scrollbar::-webkit-scrollbar-track {
  @apply dark:bg-gray-800 rounded;
}
